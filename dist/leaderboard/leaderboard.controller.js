...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get leaderboard for a tenant' }),
    (0, swagger_1.ApiQuery)({ name: 'period', required: false, enum: ['weekly', 'monthly', 'all_time'] }),
    __param(0, (0, common_1.Param)('tenantId')),
    __param(1, (0, common_1.Query)('period')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], LeaderboardController.prototype, "getRankings", null);
